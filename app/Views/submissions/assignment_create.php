                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card-primary">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted"><?= $courses->name ?></p>
                                        <strong><i class="fas fa-home mr-1"></i>&nbsp;&nbsp;Ruang</strong>
                                        <p class="text-muted"><?= $courses->room ?></p>
                                        <strong><i class="fa fa-clock mr-1"></i>&nbsp;&nbsp;Waktu</strong>
                                        <p class="text-muted"><?= $courses->schedule ?></p>
                                        <strong><i class="fas fa-pencil-alt mr-1"></i>&nbsp;&nbsp;Description</strong>
                                        <p class="text-muted">
                                            <span class="tag tag-danger"><?= $courses->description ?></span>
                                        </p>
                                        ...
                                        <div class="tab-content">
                                            <div class="active tab-pane" id="activity">
                                                ...
                                                <div class="user-block">
                                                    ...
                                                    <form action="<?= site_url('assignments/store_assignments') ?>" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="announcementText" class="form-label">Description</label>
                                                            <!-- Menggunakan CKEditor untuk textarea -->
                                                            <textarea class="form-control" id="announcementText" name="description" rows="3" placeholder="Tulis pengumuman di sini..."></textarea>
                                                        </div>
                                                        <div class="mb-3">
